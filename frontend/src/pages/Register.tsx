...
export default function Register() {
  ...
  const handleWalletRegister = async () => {
    ...
    try {
      ...
      // Register/Login with wallet (creates account automatically)
      ...
      let errorMessage = 'Failed to register with wallet. Make sure TronLink is installed and unlocked.'
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-blue-50/30 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        <div className="card p-8">
          ...
          {/* Wallet Registration - Primary Method */}
          {!showEmailRegister && (
              ...
              >
                {walletConnecting ? (
                  ...
                  <>
                    ...
                    Register with TronLink Wallet
                  </>
                )}
              </button>

              <p className="text-xs text-center text-gray-500">
                Secure registration using your TronLink wallet. Account will be created automatically.
              </p>
          ...
          {/* Email/Password Registration - Secondary Method */}
          {showEmailRegister && (
            <>
