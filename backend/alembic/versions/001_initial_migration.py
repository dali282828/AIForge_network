...
def upgrade() -> None:
    ...
    op.execute("DO $$ BEGIN CREATE TYPE grouprole AS ENUM ('OWNER', 'ADMIN', 'MEMBER', 'VIEWER'); EXCEPTION WHEN duplicate_object THEN null; END $$;")
    ...
    op.create_table(
        ...
        sa.Column('role', postgresql.ENUM('OWNER', 'ADMIN', 'MEMBER', 'VIEWER', name='grouprole', create_type=False), nullable=False, server_default='MEMBER'),
